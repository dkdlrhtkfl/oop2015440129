...
public class RememberC {
	...
	public static void main(String[] args) {
		...
		//Java는 부울 자료형과 true/false 리터럴을 사용한다. (C에서는 1/0)
		...
		//Java에서 상수를 선언하려면 final 키워드를 사용해야 한다. (C에서는 const)
		final int c = 100;
//error c는 상수	c = 1000;
...
//		ff = 3.14;
		ff = 3.14f;
		dd = 3.14; //리터럴 "3.14"의 자료형은 double이므로 float에는 뒤에 f를 붙여야 들어간다.
		...
		int x = 10;
		double y = 100.34;
//		y = x; //implicit casting y= (double) x;로 자동 변환
